...
def evict_cache_data():
    ...
    get_data_to_evict = requests.post(
        get_data_to_evict_url, json=get_data_to_evict_obj)
...
sched.add_job(evict_cache_data, 'interval', minutes=default_cache_minutes,
              start_date='2022-11-10 00:00:00', end_date='2023-11-10 14:57:00')
sched.start()
